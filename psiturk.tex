...
\section{Components of the \textsf{psiTurk} platform}

The overall structure of the psiTurk platform is shown in Figure X.  The platform
consists of a collection of software tools, some which run locally on a user's
computer and others which are hosted on the Internet (the cloud).

Command line tool
Web application server (webserver + database)
psiturk.org

In the following sections we highlight important functions of each component.
