...
\institute{
\textsf{psiTurk} was written by the listed authors at the time the
first draft of this paper was constructed (version 2.0.1).  However, many people 
continually contribute to \textsf{psiTurk}'s evolving code base via github.com.  
A public list contributions is always available  
here: http://github.com/NYUCCL/psiTurk.
\\
