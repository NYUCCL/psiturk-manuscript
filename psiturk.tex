...
\subsubsection{From the worker's perspective}
...
\subsubsection{From the requester's perspective}
...
PsiTurk runs as a command line interface (CLI) within a standard terminal window. Entering
...
whether the server is running and the number of HITs currently running on MTurk. Commands are
